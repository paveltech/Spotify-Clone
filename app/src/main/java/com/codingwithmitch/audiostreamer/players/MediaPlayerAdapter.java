...
public class MediaPlayerAdapter extends PlayerAdapter {
    ...
    private void initializeExoPlayer(){
        if (mExoPlayer == null) {
            ...
            mExoPlayer = ExoPlayerFactory.newSimpleInstance(mRenderersFactory, trackSelector, new DefaultLoadControl());
    ...
    private void playFile(MediaMetadataCompat metaData) {
        ...
        try {
            DataSource.Factory dataSourceFactory = new DefaultDataSourceFactory(mContext, Util.getUserAgent(mContext, "fire_play"), null);

            MediaSource mediaSource = new HlsMediaSource(Uri.parse(metaData.getString(MediaMetadataCompat.METADATA_KEY_MEDIA_URI)) , dataSourceFactory  ,  null , null);
